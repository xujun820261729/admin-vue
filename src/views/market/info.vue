<template>
  <div class="app-container">
      <el-form :inline="true" :model="formInline" class="form-inline" ref="formInline">
        <el-form-item label="会员手机号:"  prop="name">
            <el-input v-model="formInline.name" placeholder="会员手机号" ></el-input>
        </el-form-item>
         <el-form-item label="会员昵称:"  prop="name">
            <el-input v-model="formInline.name" placeholder="会员昵称" ></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <article class="table">
    ...
    <el-table-column align="center" label="会员头像">
        ...
        <el-table-column align="center" label="用户金额">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
