<template>
  <div class="app-container">
      <el-form :inline="true" :model="formInline" class="form-inline" ref="formInline">
        <el-form-item label="订单编号:"  prop="name">
            <el-input v-model="formInline.name" placeholder="订单编号" ></el-input>
        </el-form-item>
         ...
         <el-form-item label="手机:"  prop="name">
            <el-input v-model="formInline.name" placeholder="手机" ></el-input>
        </el-form-item>
         <el-form-item label="物流单号:"  prop="name">
            <el-input v-model="formInline.name" placeholder="物流单号" ></el-input>
        </el-form-item>
        <el-form-item>
  ...
  <article class="table">
    ...
    <el-table-column align="center" label="订单状态">
        ...
        <el-table-column align="center" label="应付款金额">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
      ...
      <el-table-column align="center" label="操作">
        <template slot-scope="scope">
          <el-button type="primary" size="small" @click="handleEdit(scope)">发货</el-button>
          <el-button type="danger" size="small" @click="handleDelete(scope)">取消订单</el-button>
        </template>
      </el-table-column>
    </el-table>
  </article>
