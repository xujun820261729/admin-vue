<template>
  ...
  <article class="table">
    ...
    <el-table :data="rolesList"  class="table-list">
      <el-table-column align="center" label="优惠券名字">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
       <el-table-column align="center" label="规格类型">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
    <el-table-column align="center" label="优惠券金额">
        ...
        <el-table-column align="center" label="使用条件，满多少金额">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
        ...
        <el-table-column align="center" label="已领取数量">
        <template slot-scope="scope">
          {{ scope.row.key }}
        </template>
      </el-table-column>
